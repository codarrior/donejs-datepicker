# Contributing to done-js-datepicker

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/Seiji/done-js-datepicker) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork done-js-datepicker, you can start by going to its [fork page](https://github.com/Seiji/done-js-datepicker/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/done-js-datepicker
```
